...
namespace com.ootii.Helpers
{
    public class ReflectionHelper
    {
        ...
        // CDL 08/15/2018 - for attributes with AllowMultipe = true
        /// <summary>
        /// Grabs all attributes of the specified Attribute type from the class type and returns it
        /// </summary>
        /// <param name="rObjectType">Object type who has the attribute value</param>
        ...
        // CDL 07/04/2018 - added this function to allow for serializedObject.FindProperty calls using a lambda 
        // expression instead of hard-coded strings.
        /// <summary>
